...
export const NotifaceIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const HomeIconActive = ({ width = '3rem', height = '3rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const FollowingIcon = ({ width = '3rem', height = '3rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const FollowingIconActive = ({ width = '3rem', height = '3rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const LiveIconActive = ({ width = '3rem', height = '3rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
